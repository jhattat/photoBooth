...
from signal import alarm, signal, SIGALRM, SIGKILL, pause
from xml.etree import ElementTree
########################
### Variables Config ###
########################
led_pin = LED(3, False) # LED 
btn_pin = Button(2) # pin for the start button
...
#led_pin.off() #for some reason the pin turns on at the beginning of the program. Why?
